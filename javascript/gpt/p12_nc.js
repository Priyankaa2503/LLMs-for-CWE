...
/**
 * p12_nc.js - Safe indexed lookup with strict bounds enforcement (JavaScript / Node.js)
 *
 * Implements getValueFromArray(array, size, index) that returns array[index]
 * when 0 <= index < size and returns -1 otherwise. The script reads an integer
 * index from standard input, performs safe parsing and validation, and exits
