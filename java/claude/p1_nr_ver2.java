...
public class SafeMemcpy {
     ...
     * @throws IndexOutOfBoundsException if the source or destination range is out of bounds
     */
     ...
     * @throws IndexOutOfBoundsException if buffer is too small for the encoded message
     */
    public static int copyMessageToBuffer(byte[] buffer, String message) {
        ...
        safeMemcpy(buffer, 0, srcBytes, 0, n);
        return n;
    }
