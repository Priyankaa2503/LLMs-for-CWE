"""
p19_fc.py - CLI add 1000 with overflow-like check (Python)

Reads one numeric command-line argument, parses it, checks that adding 1000
stays within a 64-bit signed integer range (for parity with fixed-width
languages), prints the result on success, and exits non-zero on failure.
"""
