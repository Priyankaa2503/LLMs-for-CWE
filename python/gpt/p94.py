#!/usr/bin/env python3
# p94: registration and a route skeleton (re-using pattern)
...
def register():
    ...
    try:
        con = sqlite3.connect(DB); con.execute('INSERT INTO users(username,salt,pw_hash) VALUES(?,?,?)',(username,salt,pw_hash)); con.commit(); con.close();
